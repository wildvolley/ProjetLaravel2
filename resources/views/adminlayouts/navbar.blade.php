        ...
        <nav class="mt-2">
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item has-treeview
              {{request()->is('ajout_categorie') ? 'menu-open' : ''}}
              {{request()->is('liste_categories') ? 'menu-open' : ''}}">
              <a href="#" class="nav-link 
              {{request()->is('ajout_categorie') ? 'active' : ''}}
               {{request()->is('liste_categories') ? 'active' : ''}}">
              ...
              <ul class="nav nav-treeview">
                ...
                <li class="nav-item">
                  <a href={{URL('/ajout_categorie')}} class="nav-link  {{request()->is('ajout_categorie') ? 'active' : ''}}">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Ajouter catégorie</p>
                  </a>
                </li>
                <li class="nav-item">
                  <a href={{URL('/liste_categories')}} class="nav-link {{request()->is('liste_categories') ? 'active' : ''}}">
                    <i class="far fa-circle nav-icon"></i>
            ...
            <li class="nav-item has-treeview">
              ...
              <ul class="nav nav-treeview">
                <li class="nav-item">
                  <a href={{URL('/ajout_slider')}} class="nav-link">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Ajout de sliders</p>
                  </a>
                </li>
                <li class="nav-item">
                  <a href={{URL('/ajout_article')}} class="nav-link">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Ajout d'articles</p>
                  </a>
                </li>
                <li class="nav-item">
                  <a href={{URL('/ajout_promotion')}} class="nav-link">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Ajout de promotion</p>
                  </a>
                </li>
                <li class="nav-item">
                  <a href={{URL('/ajout_publication')}} class="nav-link">
                    <i class="far fa-circle nav-icon"></i>
                ...
                <li class="nav-item">
                  <a href={{URL('/ajout_fournisseur')}} class="nav-link">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Ajout fournisseur
            ...
            <li class="nav-item has-treeview">
              ...
              <ul class="nav nav-treeview">
                <li class="nav-item">
                  <a href={{URL('/liste_articles')}} class="nav-link">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Liste des articles</p>
                  </a>
                </li>
                <li class="nav-item">
                  <a href={{URL('/liste_sliders')}} class="nav-link">
                    <i class="far fa-circle nav-icon"></i>
                ...
                <li class="nav-item">
                  <a href={{URL('/liste_fournisseurs')}} class="nav-link">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Liste des fournisseurs</p>
                  </a>
                </li>
                <li class="nav-item">
                  <a href={{URL('/liste_commandes')}} class="nav-link">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Liste des commandes</p>
                  </a>
                </li>
                <li class="nav-item">
                  <a href={{URL('/liste_paiments')}} class="nav-link">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Liste des paiments</p>
                  </a>
                </li>
                <li class="nav-item">
                  <a href={{URL('/liste_promotions')}} class="nav-link">
                    <i class="far fa-circle nav-icon"></i>
