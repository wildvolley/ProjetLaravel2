...
@section('contenu')
  ...
  <section class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1> Modification Sliders</h1>
        </div>
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href={{URL('/admin')}}>Tableau de bord</a></li>
            <li class="breadcrumb-item active">Modification-slider</li>
          </ol>
        </div>
      </div>
    </div><!-- /.container-fluid -->
        ...
        <div class="col-md-12">
          ...
          <div class="card card-primary">
            <div class="card-header">
              <h3 class="card-title">Mise à jour <small>de sliders</small></h3>
            </div>
...
<!--------------- Fin  Validation des champs obligatoires---->
            ...
            <!-- form start -->
            <form   action="{{url('/modifier_slider/{id}')}}" method="post" role="form" id="quickForm" enctype="multipart/form-data">
              {{csrf_field()}}
        ...
        --}}
                ...
                <div class="form-group">
                  ...
                  <textarea name="description1" class="form-control" required> {{$sliders->description1}}</textarea>
         {{--     <input type="text" name="description1" value= {{$sliders->description1}} class="form-control" id="description1" placeholder="Entrer la première description" required>
      ...
      --}}      
                ...
                <div class="form-group">
                    ...
                    <textarea name="description2" class="form-control" required> {{$sliders->description2}}</textarea>
      {{--          <input type="text" name="description2" value= {{$sliders->description2}} class="form-control" id="description2" placeholder="Entrer la seconde description" required>
