        ...
        <div class="col-md-12">
          ...
          <div class="card card-primary">
            <div class="card-header">
              <h3 class="card-title">Modification <small>d'articles</small></h3>
            </div>
...
<!--------------- Fin  Validation des champs obligatoires---->
            ...
            <!-- /.card-header -->
            <!-- form start -->
            <form   action="{{url('/modifier_article/{id}')}}" method="post" role="form" id="quickForm"  enctype ="multipart/form-data">
              {{csrf_field()}}
        ...
        --}}
                ...
                <input type="hidden" name="id" value={{$produits->ID_PRODUIT}}>     
                <div class="form-group">
                ...
                <div class="form-group">
                   <label for="nom_produit">Nom de l'article</label>
                    <input type="text" name="nom_produit"   value= {{$produits->NOM_PRODUIT}}  class="form-control" id="nom_produit" placeholder="Entrer le nom du produit">
          ...
          {{--      {{Form::label('nom_produit', 'Nom de l\'article')}}
              ...
              --}}
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="ref_produit" value= {{$produits->REF_PRODUIT}} class="form-control" id="ref_produit" placeholder="Entrer la référence du produit" required>
          ...
          --}}
                ...
                <div class="form-group">
                  ...
                  <input type="number" name="prix_ht_produit" value= {{$produits->PRIX_HT_PRODUIT}} class="form-control" id="prix_ht_produit" placeholder="Entrer le prix hors taxes du produit" required>
        ...
        --}}          
              ...
              <div class="form-group">
                ...
                <textarea name="description"  class="form-control" id="description"  required>{{$produits->DESCRIPTION}} </textarea>
      ...
      --}}        
        ...
        {{--        {!! Form::submit('Ajouter', ['class' => 'btn btn-primary']) !!}  --}}
            ...
            <div class="card-footer">
            <a href="{{url('liste_articles')}}" class="btn  btn-outline-primary" title="Retour">Retour</a>
            </div>
            {{--    {!!Form::close()!!}    --}}
          </div>
          <!-- /.card -->
